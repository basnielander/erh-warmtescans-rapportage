...
- Create Angular project with ng: `ng new erh.heatscans.reporting.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`erh.heatscans.reporting.client.esproj`).
